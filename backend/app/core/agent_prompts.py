...
从 agent.py 拆出:系统提示词(角色/身份/性格/局势)、动作提示词(阶段约束/
性格行为契约/可选动作)、可见状态压缩与事件格式化。Mixin 通过 self 访问
AIAgent 的 personality / prompt_variant / memory 等属性。
"""
import json
...
class PromptBuilderMixin:
    """_build_system_prompt / _build_action_prompt 等提示词构建方法。"""
